            ...
            >
              <GlowCard className="relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <NeonButton onClick={() => router.push("/session")} className="w-full sm:w-auto">
                ...
                <div className="space-y-3">
                  {upcomingMilestones.map((item, i) => (
                    <div key={i} className="flex items-center gap-3 p-3 rounded-lg bg-slate-800/50 border border-gray-700/50">
                      ...
                      <div className={`w-2 h-2 rounded-full ${item.type === "exam" ? "bg-red-400" : item.type === "test" ? "bg-yellow-400" : "bg-green-400"
                        }`} />
                    </div>
                  ))}
                </div>
