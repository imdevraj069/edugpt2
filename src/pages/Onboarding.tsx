                ...
                <div className="grid grid-cols-4 gap-3">
                  {["8", "9", "10", "11", "12", "IIT-JEE", "NEET", "Other"].map((grade) => (
                    <motion.button
                      ...
                      className={`py-3 px-4 rounded-xl border-2 text-sm font-medium transition-all ${data.grade === grade
                ...
                <div className="grid grid-cols-3 gap-3">
                  {["CBSE", "ICSE", "State Board", "IB", "IGCSE", "Other"].map((board) => (
                    <motion.button
                      ...
                      className={`py-3 px-4 rounded-xl border-2 text-sm font-medium transition-all ${data.board === board
                ...
                <div className="flex flex-wrap gap-2">
                  {["Top Board Exam Scores", "Competitive Exams", "Concept Clarity", "Better Grades", "Career Prep", "Skill Development"].map((goal) => (
                    <motion.button
                      ...
                      className={`py-2 px-4 rounded-full border-2 text-sm font-medium transition-all ${data.goals.includes(goal)
                ...
                <div className="flex flex-wrap gap-2">
                  {["Mathematics", "Physics", "Chemistry", "Biology", "English", "History", "Geography", "Computer Science", "Economics"].map((subject) => (
                    <motion.button
                      ...
                      className={`py-2 px-4 rounded-full border-2 text-sm font-medium transition-all ${data.subjects.includes(subject)
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {q.options.map((opt, optIdx) => (
                      <motion.button
                        ...
                        className={`py-2 px-3 rounded-lg border text-xs font-medium transition-all ${data.diagnosisAnswers[idx] === optIdx
                            ? "border-cyan-400 bg-cyan-400/20 text-cyan-400"
        ...
        <div className="mb-8">
          <div className="flex justify-between mb-2">
            {[...Array(totalSteps)].map((_, i) => (
              <motion.div
                key={i}
                className={`flex-1 h-2 mx-1 rounded-full ${i <= step ? "bg-gradient-to-r from-cyan-400 to-teal-400" : "bg-slate-700"
                  }`}
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
